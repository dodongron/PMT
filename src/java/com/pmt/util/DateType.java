...
public class DateType {
    ...
    public static SimpleDateFormat time4 = new SimpleDateFormat("HH:mm aa");
    ...
    public static SimpleDateFormat slash3 = new SimpleDateFormat("yyyy/MM/dd HH:mm");
     public static SimpleDateFormat slash4 = new SimpleDateFormat("yyyy/MM/dd HH:mm aa");
