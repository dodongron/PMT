 ...
 * @author Guinness
 */
public class AddSpotInvestigationAction extends ActionSupport implements SessionAware {
    ...
    public AddSpotInvestigationAction() {
    }
