 ...
 * @author Guinness
 */
public class UpdateSpotInvestigatioFormAction extends ActionSupport implements SessionAware {
    ...
    public UpdateSpotInvestigatioFormAction() {
    }
    ...
    public String execute() throws Exception {
        ...
        session.put("p_spotId", spotId);
        session.put("p_sir_date", sir_date);
        session.put("p_sir_datetime_of_occurence", sir_datetime_of_occurence);
        session.put("p_sir_departure_time", sir_departure_time);
        session.put("p_sir_arrival_time", sir_arrival_time);
        session.put("p_sir_type_of_occupancy", sir_type_of_occupancy);
        session.put("p_sir_name_of_establishment", sir_name_of_establishment);
        session.put("p_sir_owner", sir_owner);
        session.put("p_sir_occupant", sir_occupant);
        session.put("p_sir_casualty", sir_casualty);
        session.put("p_sir_estimated_damage", sir_estimated_damage);
        session.put("p_sir_time_fire_started", sir_time_fire_started);
        session.put("p_sir_time_fire_out", sir_time_fire_out);
        session.put("p_sir_time_alarm_received", sir_time_alarm_received);
        session.put("p_sir_details_of_investigation", sir_details_of_investigation);
        session.put("p_sir_disposition", sir_disposition);
        session.put("p_sir_place_of_occurence", sir_place_of_occurence);
        return "success";
    }
